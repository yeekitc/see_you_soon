...
def splashScreenMode_timerFired(app):
    ...
    if app.welcInd+1 != len(app.welcText) and app.splashTimer%8 == 0:
        ...
        if app.slideX <= app.width:
            ...
            app.slideX0 += 10
        # enter landing page if animation is finished
        else:
...
def signUpMode_timerFired(app):
    ...
    # controls the cursor blinks of the text boxes
    ...
    if user != "" and pw != "" and confirm != "":
        ...
        if user in app.accounts:
            ...
            app.signUpExists = False
        # disable/enable the proceed button based on whether the passwords match
        # and whether the user account already exists
